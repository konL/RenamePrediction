...
def load_data(filename):
    ...
    return df[['oldname','oldStmt', 'newStmt' ,'oldStmt_body', 'newStmt_body','changeNum','label_class']].values, df[['oldname','oldStmt', 'newStmt','oldStmt_body', 'newStmt_body','changeNum','label_class']]
